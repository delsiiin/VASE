...
# vicuna 33b 4bit
python allocation.py --outdir train_data_vicuna33b \
                    --type vicuna \
                    --basemodel /root/MODELS/vicuna-33b-v1.3 \
                    --data /root/idea/speculative_decoding/sharegpt_medusa/ShareGPT_V4.3_unfiltered_cleaned_split.json 
...
# llama3 8b
python allocation.py --outdir train_data_llama38b \
                    --type llama3 \
                    --basemodel  /root/MODELS/Meta-Llama-3-8B-Instruct \
                    --data /root/idea/speculative_decoding/sharegpt_medusa/ShareGPT_V4.3_unfiltered_cleaned_split.json 
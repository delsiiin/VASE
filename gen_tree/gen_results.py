...
def explore_graph(accuracies, max_depth, max_child, num_iterations):
    ...
    for _ in range(num_iterations):
        ...
        print(best_neighbor_expectation)
        expectations += best_neighbor_expectation
        
    return accept_nodes, explored_nodes
...
def main():
    ...
    accept_nodes, explored_nodes = explore_graph(accuracies, args.max_depth, args.max_child, args.num_iterations)
    
    print("Accepted Nodes:", accept_nodes)
    
    try:
        plot_and_save_graph(accept_nodes, args.output_path)
        plot_and_save_graph(explored_nodes, args.ex_output_path)

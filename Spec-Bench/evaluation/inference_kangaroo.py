...
from model.kangaroo.kangaroo_model import KangarooModel

def kangaroo_forward(inputs, model, tokenizer, max_new_tokens, max_length = 2048, EARLY_STOP_LAYER = 2, SPECULATIVE_DECODING_STEPS = 6, threshold = 0.6):
...
if __name__ == "__main__":
    ...
    args.model_id = args.model_id+"-threshold-"+str(args.threshold)

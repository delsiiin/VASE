...
from model.ssd.utils_eagle import *
...
def ssd_forward_eagle(inputs, model, tokenizer, max_new_tokens, medusa_choices=None, temperature=0.0, posterior_threshold=0.09, posterior_alpha=0.3, max_steps=512):
